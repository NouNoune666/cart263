...
function go_all_stuff() {
    ...
    drawingBoardA.addObj(new CircularObj(20, 100, 20, "#FFC300", "#E6E6FA", drawingBoardA.context))
     ...
     * 
     */
    let circularObj = new CircularObj(20, 100, 20, "#FFC300", "#E6E6FA", drawingBoardA.context);
